	 ...
	 function twentytwelve_comment( $comment, $args, $depth ) {
        ...
        switch ( $comment->comment_type ) :
            ...
            default:
                ...
                $initials = '';
                if (strpos($comment_author, ' ') !== false) {
                    list($firstName, $lastName) = explode(' ', $comment_author, 2);
                    $initials = mb_substr($firstName, 0, 1) . mb_substr($lastName, 0, 1);
                } else {
                    $initials = mb_substr($comment_author, 0, 1);
                }
                ...
                <article id="comment-<?php comment_ID(); ?>" class="comment">
                    ...
                    <span class="comment-author-initials"><?php echo esc_html($initials); ?></span>
                    ...
                    <div class="comment-actions">
                        ...
                        <?php edit_comment_link( __( 'Edit', 'twentytwelve' ), '<div class="edit-link">', '</div>' ); ?>
                    </div>
                </article>
                </li>
                <?php
