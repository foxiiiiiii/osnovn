(function() {
    ...
    const link = el('a', { href: '#', onclick: toggle }, 'Изменить' );
    ...
    const submitButton = el('input', { type: "button", value: "Приминить", className: "button", onclick: onSubmit });
    const form = el('form', {
        method: "POST",
        onsubmit: onSubmit,
        style: { display: "none" }
    ...
    function onSubmit(evt) {
        ...
        submitButton.value = "Пожалуйста подождите..";
